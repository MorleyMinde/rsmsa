...
<div layout="row" style="padding-top: 200px" >
  ...
  <div class="col-md-6" >
	...
	<!-- <h4  style="color:black;font-weight: bold;line-height: 100%">Welcome to the Integrated Road Safety Management System(iRoad)</h4>
       ...
       <img src="img/applications.png" width="800px"/>
...
:-ms-input-placeholder {  
   ...
   opacity:  1;  
    ...
    <div class="col-md-4" style="padding-right: 100px;padding-top:50px">
 <form class="form-signin" action="{{ url('login') }}"  method="post">
 <h3 class="form-signin-heading">Iroad(Integrated Road Safety Management System)</h3>
<h6 class="form-signin-heading" style="color:black;font-weight: bold">Please Enter Your Credentials To Access The System</h6>
        ...
        @endif
               <div class="login-wrap">
                    ...
                    <input type="text" class="form-control" style="background-color:transparent;border: 2px solid grey;" placeholder="Police Rank Number" autofocus name="rankNo" required style="margin-bottom: 15px;border: 0px;border-bottom: 1px solid">

                    <input type="password" class="form-control"  style="background-color:transparent;margin-top:10px;border: 2px solid grey;" placeholder="Password" name="password" required style="border: 0px;border-bottom: 1px solid">
                    ...
                    <button class="btn btn-primary btn-block"  style="  background-color: #4C5861;"name="submit" type="submit" ng-disabled="login_form.$invalid">Sign in</button>
