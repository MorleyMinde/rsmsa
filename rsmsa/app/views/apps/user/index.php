...
<head>
    ...
    <script src="<?php echo asset('apps/user/routes.js')?>"></script>
    <script src="<?php echo asset('apps/user/controllers/userAppCtrl.js')?>"></script>
</head>

<body style="" ng-controller="userAppCtrl">
<div class="container">
        ...
        <section layout="row" flex>
            <md-sidenav class="md-sidenav-left md-whiteframe-z2"
                ...
                <md-list>
                    ...
                    <md-item>
                        <md-item-content>
                            <a href="#/home" style="width:100%" ng-click="closeNav()"><md-button class="sub-menu-button">Users</md-button></a>
                        </md-item-content>
                    </md-item>
