...
class PersonTableSeeder extends Seeder{
	...
	public function run()
	{
		$arrays = array(
                ...
                array('first_name' => 'Kelvin','last_name' => 'Mbwillo','address' => 'P.O. Box 1980 Dar','gender' => 'M','birthdate' => '2015-01-14','phone_number' => '+255718776492','email' => 'kelvinmbwillo@gmail.com'),
        );
		DB::table('rsmsa_persons')->delete();

		foreach($arrays as $arr)
		{
			DB::table('rsmsa_persons')->insert($arr);
		}
	}
}