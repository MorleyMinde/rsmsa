  ...
  if ($no_of_rows > 0) {
   ...
   /*
    ...
    public function storeOffence($license, $plateNumber, $offence, $commit, $rankNo, $amount, $latitude, $longitude) {
        ...
        $result = mysql_query("INSERT INTO offenses( driver_license_number, vehicle_plate_number, offence, commit,amount, rank_no, latitude, longitude) VALUES('$license', '$plateNumber', '$offence', '$commit', '$amount','$rankNo','$latitude','$longitude')");
